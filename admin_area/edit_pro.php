...
<body bgcolor="skyblue">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="1195" border="2" bgcolor="#188fae">
			<tr align="center">
			...
			<tr>
				...
				<td>
				<select name="product_cat"><option><?php echo $category_title; ?></option>
					<?php
...
if(isset($_POST['update_product'])) {
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $update_product = "update products set product_title='$product_title', product_cat='$product_cat', product_brand='$product_brand', product_image='$product_image',product_price='$product_price', product_desc='$product_desc', product_keywords='$product_keywords' where product_id='$update_id'";
