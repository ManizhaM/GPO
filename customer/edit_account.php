	...
	?>
			...
			<table align="center" width="750">
				...
				<tr align="center">
					<td colspan="6"><h2>Edit my account </h2></td>
				</tr>
				...
				<tr>
					<td align="right">Your Telephone Number: </td>
				...
				<tr align="center">
					<td colspan="6"><input type="submit" name="update" value="Edit account"></td>
